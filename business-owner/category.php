            ...
            <div class="col-md-12">
                <div class="card">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="card">
                                                <div class="card-body">
                                                    <form action="./controller-files/category-controller/insert-category.php" method="post" id="cat_form">
                                                        <div class="row">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" name="add_category" value="Add_category" class="btn btn-primary">
                                                Save changes
                                            </button>
                                            </form>
                                        </div>
                    ...
                    <div class="card-body">
                        ...
                        //$sql = "SELECT * from product_cat limit $offset,$limit";
                        if ($_SESSION["user_role"] == '0') {
                            /* select query of category table for admin user */
                            $sql = "SELECT * FROM product_cat ORDER BY product_cat_id DESC LIMIT {$offset},{$limit}";
                        } elseif ($_SESSION["user_role"] == '1') {
                            /* select query of category table for seller user */
                            $sql = "SELECT * FROM product_cat where product_cat.business_id = {$_SESSION['business_id']}
                            ORDER BY product_cat.product_cat_id DESC LIMIT {$offset},{$limit}";
                        }
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu shadow-lg rounded mt-1" aria-labelledby="dropdownMenuButton1">
                                                            <?php if ($_SESSION["user_role"] == '1') { ?>
                                                                <li>
                                                                    <a class="dropdown-item btn" href='update-category.php?id=<?php echo $row['product_cat_id']; ?>'>Edit</a>
                                                                </li>
                                                            <?php } ?>
                                                            <li>
                                                                <a class="dropdown-item" href='./controller-files/category-controller/delete-category.php?id=<?php echo $row['product_cat_id']; ?>'>Delete</a>
                                                            </li>
                                                        </ul>
                        ...
                        <?php
                        //$sql1 = "SELECT COUNT(product_cat_id) FROM product_cat";
                        if ($_SESSION["user_role"] == '1') {
                            $sql1 = "SELECT * FROM product_cat where business_id = {$_SESSION['business_id']} ";
                        ...
                        ?>
                            <div class="row mt-2">
                                <ul class="pagination justify-content-center">
                                    ...
                                    <a class='page-link' href='category.php?page=" . ($page - 1) . "' aria-label='Previous'>
                                    ...
                                    if ($total_page > $page) {
                                        echo " <li class='page-item'>
                                    <a class='page-link' href='category.php?page=" . ($page + 1) . "' aria-label='Next'>
