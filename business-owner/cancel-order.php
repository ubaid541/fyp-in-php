                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if ($_SESSION["user_role"] == '0') {
                            ...
                            left join product_attributes on product_order.attr_ID = product_attributes.attr_ID
                            left join rider on product_order.rider = rider.rider_ID
                            where  product_order.business_id = {$_SESSION['business_id']} and product_order_status = 2
                            ORDER BY product_order.order_ID DESC LIMIT {$offset},{$limit}";
                        }
                        ...
                        <?php
                        if ($_SESSION["user_role"] == '1') {
                            $sql1 = "SELECT * FROM product_order where business_id = {$_SESSION['business_id']} and product_order_status = 2";
                        } else if ($_SESSION["user_role"] == '0') {
                            $sql1 = "SELECT * FROM product_order where product_order_status = 2 ";
                        }
                        ...
                        ?>
                            <div class="row mt-2">
                                <ul class="pagination justify-content-center">
                                    ...
                                    <a class='page-link' href='cancel-orders.php?page=" . ($page - 1) . "' aria-label='Previous'>
                                    ...
                                    if ($total_record > $limit) {
                                        ...
                                        <a class='page-link' href='cancel-orders.php?page=" . $i . "'>$i</a>
                                    </li>";
                                        }
                                    }
                                    ...
                                    if ($total_page > $page) {
                                        echo " <li class='page-item'>
                                    <a class='page-link' href='cancel-orders.php?page=" . ($page + 1) . "' aria-label='Next'>
