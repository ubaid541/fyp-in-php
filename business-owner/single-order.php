                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <img src="./uploads/<?php echo $order['product_image']; ?>" alt="food image" />
                                                </td>
                                                <?php if ($_SESSION['user_role'] == '1') { ?>
                                                    <td><a href='./update-product.php?id=<?php echo $order['pro_id']; ?>'><?php echo $order['product_name']; ?></a></td>
                                                <?php } else { ?>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        if ($_SESSION['user_role'] == '1') {
                                            ...
                                            $query =  mysqli_query($conn, "SELECT count(order_ID) as orders from product_order where  user_id = '$user_id'");
                                        }
