            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        $sql = "SELECT rider_shifts.*,rider.rider_ID,rider.shift from rider_shifts left join rider on rider.shift = rider_shifts.shift_id limit $offset,$limit";
                                ...
                                <table class="table data-table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <?php if ($_SESSION["user_role"] == '2') { ?><th scope='col'>Action</th><?php } ?>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <?php if ($_SESSION["user_role"] == '2') { ?>
                                                    <td>
                                                        <?php if ($row['shift'] == 0) { ?>
                                                            <a href="./controller-files/start-stop-shift/start-shift.php?id=<?php echo $row['shift_id']; ?>" type="submit" class="btn btn-primary">Start</a>
                                                        <?php } else { ?>
                                                            <a href="./controller-files/start-stop-shift/stop-shift.php?id=<?php echo $row['shift_id']; ?>" type="submit" class="btn btn-danger">Finish</a>
                                                        <?php } ?>
                                                    </td>
                                                <?php } ?>
                                                <td>
