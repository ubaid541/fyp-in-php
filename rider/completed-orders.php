                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            where product_order.rider = {$_SESSION['rider_ID']} and product_order_status = 1
                            ...
                            $sql1 = "SELECT * FROM product_order where product_order.rider = {$_SESSION['rider_ID']} and product_order_status = 1";
