                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            where product_order.rider = 0 or product_order.rider = {$_SESSION['rider_ID']}
                            ...
                            ?>
                                <div class="row mt-2">
                                    ...
                                    <a class='page-link' href='orders.php?page=" . ($page - 1) . "' aria-label='Previous'>
                                        ...
                                        if ($total_page > $page) {
                                            echo " <li class='page-item'>
                                    <a class='page-link' href='orders.php?page=" . ($page + 1) . "' aria-label='Next'>
                                ...
                                ?>
                                <h4>Kindly Start a <a href="./shifts.php" class="text-primary"> shift </a> first to get orders.</h4>
                            <?php } ?>
                                </div>
                        </div>
                    </div>
...
<!-- SELECT distinct(product_order.user_id),product_order.*,products.*,user.*,business.*,rider.* 
                            from product_order
                            left join products on product_order.product_ID = products.pro_id 
                            left join user on product_order.user_id = user.user_id
                            left join business on product_order.business_id = business.business_id
