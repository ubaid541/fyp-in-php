                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        $sql = "SELECT product_order.*,products.*,product_addons.*,product_attributes.*,user.*,business.*,rider.*
                            ...
                            where  product_order.user_id = {$_SESSION['user_id']}
                        ...
                        <?php
                        $sql1 = "SELECT * FROM product_order where user_id = {$_SESSION['user_id']} ";
                        ...
                        ?>
                            <div class="row mt-2">
                                <ul class="pagination justify-content-center">
                                    ...
                                    <a class='page-link' href='order-history.php?page=" . ($page - 1) . "' aria-label='Previous'>
                                    ...
                                    if ($total_record > $limit) {
                                        ...
                                        <a class='page-link' href='order-history.php?page=" . $i . "'>$i</a>
                                    </li>";
                                        }
                                    }
                                    ...
                                    if ($total_page > $page) {
                                        echo " <li class='page-item'>
                                    <a class='page-link' href='order-history.php?page=" . ($page + 1) . "' aria-label='Next'>
